...
<div class="dashboard-wrapper">
    ...
    <div class="welcome-card animate__animated animate__fadeInDown">
        ...
        <h1 class="fw-bold">Panel de Vendedor</h1>
        <p class="fs-5 opacity-75">
            Bienvenido, <strong><?php echo $_SESSION['fullname']; ?></strong>.
        </p>
    ...
    <div class="actions-grid animate__animated animate__fadeInUp">
        ...
        <!-- Botón para ir a Crear Producto -->
        <a href="inicio.php?op=agregar_producto" class="action-btn">
