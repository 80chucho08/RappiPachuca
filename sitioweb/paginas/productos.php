        ...
        <?php foreach ($productos as $prod): ?>
            <div class="col-6 col-md-3">
                <div class="card shadow-sm h-100">
                    <img src="imagenes/<?php echo $prod['product_image']; ?>" 
                         class="card-img-top" 
                         style="height: 150px; object-fit: cover;">

                    <div class="card-body">
                        <h6 class="card-title fw-bold"><?php echo $prod['product_title']; ?></h6>
                        <p class="text-muted small"><?php echo $prod['product_description']; ?></p>
                        <p class="fw-bold text-success">$<?php echo $prod['product_cost']; ?></p>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
